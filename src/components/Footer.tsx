      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '40px', marginBottom: '40px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            ...
            <a href="tel:+576016672681"
              style={{ fontSize: '13px', color: '#AAA', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '8px', transition: 'color 0.2s' }}
              onMouseEnter={e => e.currentTarget.style.color = '#00C4AD'}
              onMouseLeave={e => e.currentTarget.style.color = '#AAA'}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" width="14" height="14"><path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h2.28a1 1 0 01.98.804l.938 4.688a1 1 0 01-.54 1.1l-1.9.95a11.042 11.042 0 005.516 5.516l.95-1.9a1 1 0 011.1-.54l4.688.938a1 1 0 01.804.98V19a2 2 0 01-2 2h-1C7.82 21 3 16.18 3 10V5z"/></svg>
              601 6672681
            </a>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
              <svg viewBox="0 0 24 24" fill="none" stroke="#888" strokeWidth="1.8" width="14" height="14" style={{ marginTop: '2px', flexShrink: 0 }}><path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a2 2 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><circle cx="12" cy="11" r="3"/></svg>
              <span style={{ fontSize: '12px', color: '#666', lineHeight: 1.5 }}>Calle 93a # 13-24, Piso 5, Edificio QBO, Bogotá</span>
            </div>
            <a href="#contacto"
              style={{ fontSize: '13px', color: '#AAA', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '8px', transition: 'color 0.2s' }}
              onMouseEnter={e => e.currentTarget.style.color = '#00C4AD'}
