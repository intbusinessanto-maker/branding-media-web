...
const SOCIALS = [
  {
    ...
    bg: '#0A66C2',
    size: 'clamp(80px, 9vw, 144px)',
    pos: { top: '8%', right: 'max(28%, calc(50% - 26vw + 15px))' }, floatDur: 5.9, floatDelay: '0.6s',
  ...
  },
  {
    ...
    pos: { top: '8%', left: 'max(28%, calc(50% - 26vw + 15px))' }, floatDur: 5.4, floatDelay: '0s',
  ...
  },
  {
    ...
    pos: { top: '58%', left: 'max(26%, calc(50% - 26vw + 15px))' }, floatDur: 6.3, floatDelay: '1.2s',
  ...
  },
  {
    ...
    pos: { top: '58%', right: 'max(26%, calc(50% - 26vw + 15px))' }, floatDur: 6.8, floatDelay: '1.8s',
  ...
  },
  {
    ...
    bg: '#25D366',
    size: 'clamp(68px, 7.5vw, 92px)',
    pos: { top: '34%', right: 'max(25%, calc(50% - 26vw + 15px))' }, floatDur: 7.2, floatDelay: '2.4s',
    ...
    <section ref={ref} className="logo-showcase-section" style={{
      ...
      <style>{`
        ...
        @media (max-width: 767px) {
          ...
          .social-linkedin { top: 14% !important; left: 2% !important; right: auto !important; }
          .social-linkedin > div { width: 88px !important; height: 88px !important; }

          /* Instagram — arriba derecha */
          .social-instagram { top: 10% !important; left: auto !important; right: 2% !important; }
          .social-instagram > div { width: 72px !important; height: 72px !important; }

          /* Facebook — abajo izquierda */
          .social-facebook { top: 62% !important; left: 4% !important; right: auto !important; }
          .social-facebook > div { width: 68px !important; height: 68px !important; }

          /* WhatsApp — abajo centro */
          .social-whatsapp { top: 58% !important; left: 50% !important; right: auto !important; transform: translateX(-50%) !important; }
          .social-whatsapp > div { width: 84px !important; height: 84px !important; }

          /* TikTok — abajo derecha */
          .social-tiktok { top: 63% !important; left: auto !important; right: 4% !important; }
          .social-tiktok > div { width: 56px !important; height: 56px !important; }
        }
      `}</style>
